    ...
    for (path, dir, files) in os.walk(xml_folder_path) :
        for filename in files :
            ...
            if ext == ".xml_to_yolo" :
                ...
                # ./xml_data/test.xml_to_yolo
                all_root.append(root)
            else :
                print("no xml_to_yolo files.....")
                break
...
# test = glob.glob(os.path.join(xml_folder_path, "*.xml_to_yolo"))
